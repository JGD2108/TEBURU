...
## Corpus Check
- 104 files · ~38,773 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 445 nodes · 716 edges · 55 communities (31 shown, 24 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb3f8b42`
...
1. `isAuthorizationFailure()` - 49 edges
2. `requireRole()` - 48 edges
3. `query()` - 45 edges
...
Cohesion: 0.07
Nodes (51): DELETE(), GET(), POST(), GET(), PATCH(), { requireRole, query }, GET(), PATCH() (+43 more)
...
### Community 41 - "activate/route.ts"
Cohesion: 0.23
...
## Knowledge Gaps
- **165 isolated node(s):** `required`, `missing`, `eslintConfig`, `name`, `version` (+160 more)
